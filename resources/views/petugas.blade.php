    ...
    <table class="w-full text-sm text-left text-gray-400">
        ...
        <tbody>
            ...
            <tr class="border-b bg-gray-800 border-gray-700 hover:bg-gray-600">
                ...
                <td class="px-6 py-4">
                    <button type="button" data-modal-target="modal-edit" data-modal-toggle="modal-edit{{$p->id_petugas}}" class="text-white focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-blue-800">Edit</button><button type="button" data-modal-target="modal-hapus" data-modal-toggle="modal-hapus" class="text-white focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-red-800">Hapus</button>
                </td>
            </tr>
            <!-- Modal Edit -->
            <div id="modal-edit{{$p->id_petugas}}" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                    ...
                    <div class="relative rounded-lg shadow bg-gray-700">
                        ...
                        <form name="formpetugasedit" id="formpetugasedit" action="/petugas/edit/{{$p->id_petugas}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                <input type="text" name="nama_petugas" id="nama_petugas" class="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 appearance-none text-white border-gray-600 focus:border-blue-500 focus:outline-none focus:ring-0 peer" value="{{$p->nama_petugas}}"/>
                                <label for="nama_petugas" class="peer-focus:font-medium absolute text-sm text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Nama Petugas</label>
                            </div>
                            <div class="relative z-0 w-full mb-6 group">
                                <input type="text" name="hp" id="hp" class="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 appearance-none text-white border-gray-600 focus:border-blue-500 focus:outline-none focus:ring-0 peer" value="{{$p->hp}}" required />
          ...
          <div class="relative rounded-lg shadow bg-gray-700">
              ...
              <div class="p-6 space-y-6 bg-gray-900">
                <form name="formpetugastambah" id="formpetugastambah" action="/petugas/tambah" method="post" enctype="multipart/form-data">
                    ...
                    <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" name="nama_petugas" id="nama_petugas" class="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 appearance-none text-white border-gray-600 focus:border-blue-500 focus:outline-none focus:ring-0 peer" placeholder="" required />
                        <label for="nama_petugas" class="peer-focus:font-medium absolute text-sm text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Nama Petugas</label>
                    </div>
                    <div class="relative z-0 w-full mb-6 group">
                    ...
                    <button type="submit" name="petugastambah" class="focus:ring-4 focus:outline-none text-white bg-green-700 hover:bg-green-600 focus:ring-green-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                        Tambah
                    </button>
      ...
      <div class="relative w-full max-w-md max-h-full">
          <div class="relative rounded-lg shadow bg-gray-700">
              ...
              <div class="p-6 text-center">
                  ...
                  <a href="petugas/hapus/{{$p->id_petugas}}" class="focus:ring-4 focus:outline-none text-white bg-red-700 hover:bg-red-600 focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                      Hapus
                  </a>
